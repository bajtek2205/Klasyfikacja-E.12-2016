- Zamontować zasilacz oraz dyski (juz jest z Windowsem) 
...
- Uzyc linii komend do sprawdzenia dysku w poszukiwaniu błędów (w cmd wpisałem chkdsk) 
...
- Zainstalowac linuxa.
- Czas wyboru zmienic na 15 sek (ja dalem nano /etc/default/grub i tam timeout z 10 na 15 ctrl+o zapisuje enter potwierdzam ctrl+x wychodze do terminala, a nastepnie wymagane jest aktolizowanie ustawien: update-grub 
...
- Wyswietlic dyski i partycje (chyba df -h przypomniałem to sobie po egzaminie) i screenshot. Opcjonalnie można dopisać argument -H dla poprawienia czytelnosci. 
